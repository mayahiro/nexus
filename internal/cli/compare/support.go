...
func PrintHelp(w io.Writer) {
	fmt.Fprintln(w, "usage: nxctl compare <old-url> <new-url> [--backend chromium|lightpanda] [--viewport <width>x<height>] [--wait-selector <css>] [--scope-selector <css>] [--wait-function <js>] [--wait-network-idle] [--wait-timeout <ms>] [--compare-css] [--css-property <name>]... [--compare-layout] [--ignore-text-regex <regex>]... [--ignore-selector <rule>]... [--mask-selector <rule>]... [--output-json <file>] [--output-md <file>] [--json]")
	fmt.Fprintln(w, "   or: nxctl compare --old-session <id> --new-session <id> [--wait-selector <css>] [--scope-selector <css>] [--wait-function <js>] [--wait-network-idle] [--wait-timeout <ms>] [--compare-css] [--css-property <name>]... [--compare-layout] [--ignore-text-regex <regex>]... [--ignore-selector <rule>]... [--mask-selector <rule>]... [--output-json <file>] [--output-md <file>] [--json]")
	...
	fmt.Fprintln(w, "scope: --scope-selector accepts a raw CSS selector, must match exactly one element on each side, and may use positional selectors such as :nth-child()")
	fmt.Fprintln(w, "manifest: defaults and pages support backend, viewport, wait_*, scope_selector, compare_css, compare_layout, css_property, ignore_selector, and mask_selector")
	fmt.Fprintln(w, "")
