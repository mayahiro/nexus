...
func PrintHelp(w io.Writer) {
	...
	fmt.Fprintln(w, "manifest review packet: --manifest with --review-dir writes manifest summaries, review-index.md/html, finding clusters, cropped finding previews, and one review packet directory per page")
	fmt.Fprintln(w, "")
