...
func PrintHelp(w io.Writer) {
	...
	fmt.Fprintln(w, "review packet: --review-dir writes compare.json, compare.md, decision templates, full-page screenshots, cropped finding screenshots, and review-summary.json")
	...
	fmt.Fprintln(w, "manifest review packet: --manifest with --review-dir writes manifest summaries, review-index.md/html, cropped finding previews, and one review packet directory per page")
	fmt.Fprintln(w, "")
