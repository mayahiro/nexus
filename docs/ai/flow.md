...
- `defaults`: shared defaults such as `backend`, `target_ref`, `viewport`, `wait_timeout`, `compare_css`, `compare_layout`, `scope_selector`, `old_scope_selector`, `new_scope_selector`, `css_property`, `ignore_text_regex`, `ignore_selector`, and `mask_selector`
...
`compare` supports step-level overrides such as `compare_css`, `compare_layout`, `scope_selector`, `old_scope_selector`, `new_scope_selector`, `css_property`, `ignore_text_regex`, `ignore_selector`, and `mask_selector`.
