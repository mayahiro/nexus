...
With `--manifest`, `--review-dir review/migration` writes manifest-level summaries, `review-index.md`, `review-index.html`, and one review packet directory per page. The HTML index shows screenshots plus the first critical and warning findings for each page.
