...
Use `--review-dir review/orders` to write an AI review packet containing `compare.json`, `compare.md`, pair and finding decision templates, full-page screenshots, best-effort cropped finding screenshots, repeated finding clusters, and `review-summary.json`. The review summary includes next commands for validating locator-friendly decisions, materializing them to concrete refs, and normalizing the final JSONL.
