...
Use `--output-decisions-template pair-decisions.todo.jsonl` to write editable JSONL stubs for ambiguous candidates. Stubs include the old node locator when available, and candidate notes include new refs, locators, scores, and shared/differing keys.
